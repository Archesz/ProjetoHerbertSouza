...
const depoimentos = [
    {"Nome": "João Vitor", "Foto": "jovi", "Curso": "Ciência da Computação", "Universidade": "Unicamp"},
    {"Nome": "Barbara Cristina", "Foto": "barbara", "Curso": "Medicina", "Universidade": "USP"},
    {"Nome": "Marcia Anacleto", "Foto": "marcia", "Curso": "Pedagogia", "Universidade": "Unicamp"},
    {"Nome": "Samuel Augusto", "Foto": "samuca", "Curso": "Geologia", "Universidade": "Unicamp"},
    {"Nome": "Giovana Helena", "Foto": "giovana", "Curso": "Tec Mecatrônica", "Universidade": "Cotuca"},
]
    ...
    return (
        <div className={`depoimentos-container`}>
            ...
            <div className='depoimento-texto'>
                "Conheço e participo do Herbert desde que me entendo como pessoa, as experiências, vivências, aprendizados e o tempo no projeto foram marcos que dividiram minha vida, sou grato a todos que mantém esse projeto vivo!"
            </div>
